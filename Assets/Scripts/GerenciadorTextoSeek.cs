...
public class GerenciadorTextoSeek : MonoBehaviour {
	...
	void Update () {
		...
		textPosXAgente.text = "Pos X - Agente:" + seek.transform.position.x.ToString();
		textPosYAgente.text = "Pos Y - Agente:" + seek.transform.position.y.ToString();
		...
		Vector2 newDirectionN = seek.DirecaoNormalizada;
		textVetorDirecaoN.text = "Vetor Direção Normalizada: " + newDirectionN.ToString();
		Vector2 newDirection = seek.Direcao;
		textVetorDirecao.text = "Vetor Direção: " + newDirection.ToString();
		textVelocidadeDesejadaX.text = "Velocidade Desejada X: " + seek.Velocity.x.ToString();
		textVelocidadeDesejadaY.text = "Velocidade Desejada Y: " + seek.Velocity.y.ToString();
	}
}
